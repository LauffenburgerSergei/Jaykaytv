...
final class Version20220414080756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE films (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, annee INT NOT NULL, genre_1 INT NOT NULL, genre_2 INT DEFAULT NULL, genre_3 INT DEFAULT NULL, acteurs LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', synopsis LONGTEXT NOT NULL, images VARCHAR(255) NOT NULL, duree INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
